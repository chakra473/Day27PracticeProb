...
namespace Day27PracticeProblem
{
    /// <summary>
    ...
    internal class AddressBook
    {
        ...
        public AddressBook()
        {
            string json = File.ReadAllText(@"D:\BRIDGELABZVS\Day27\Day27PracticeProblem\Day27PracticeProblem\File.json");
            if (json.Length > 0)
            {
        ...
        public void addPerson(Person p)
        {
            ...
            File.WriteAllText(@"D:\BRIDGELABZVS\Day27\Day27PracticeProblem\Day27PracticeProblem\File.json", jsonData);
        }
    }
